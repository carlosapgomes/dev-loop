...
description: Configura um novo projeto seguindo o workflow ESAA Solopreneur para repositórios públicos forkáveis. Cria estrutura de diretórios, templates de AGENTS.md, PROJECT_CONTEXT.md, e documentação inicial.
---

# Skill: Setup Solopreneur Project

Este skill ajuda a configurar um novo projeto (ou adaptar um existente) para seguir o workflow ESAA Solopreneur v4.2, otimizado para repositórios públicos do setor público que precisam ser forkáveis e rastreáveis.
...
Este skill inclui `setup_project.py` para bootstrap determinístico da estrutura ESAA.
...
3. Configure CI/CD para rodar comandos de validação automaticamente
