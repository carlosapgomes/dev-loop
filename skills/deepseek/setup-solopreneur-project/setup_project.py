#!/usr/bin/env python3
"""
Bootstrap a project to ESAA Solopreneur structure.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Bootstrap ESAA Solopreneur project structure")
