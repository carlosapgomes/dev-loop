...
/esaa-django-insights --export=relatorio-django-2026-03-02.md
```

### Exemplo 2: Foco em Performance

```
$ /esaa-django-insights --focus=performance
...
```
$ /esaa-django-insights --app=payments
...
```bash
# Mensalmente
/esaa-django-insights > relatorio-mensal.md

# Antes de refatorar
/esaa-django-insights --focus=performance

# Ao herdar projeto
/esaa-django-insights --export=diagnostico-inicial.md
```
...
```bash
cp -r esaa-django-insights ~/.pi/skills/
