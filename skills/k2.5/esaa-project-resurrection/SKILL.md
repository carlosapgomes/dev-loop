# Skill: esaa-project-resurrection
...
```
Usuário: /esaa-project-resurrection
...
Manhã: Projeto A
Tarde: Projeto B
/esaa-project-resurrection  # 1 min para relembrar
Noite: Projeto C
/esaa-project-resurrection  # 1 min para relembrar
```
...
```
Segunda: /esaa-project-resurrection
...
```
Após 1 mês: /esaa-project-resurrection
...
```
Após 6 meses: /esaa-project-resurrection
...
cp -r esaa-project-resurrection ~/.pi/skills/

# 2. Instalar dependências (se necessário)
pip install GitPython python-dateutil pyyaml

# 3. Skill disponível como /esaa-project-resurrection
```
