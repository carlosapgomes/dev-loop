...
5. [ ] Commit atômico (`1 slice = 1 commit`)
6. [ ] Marcar task `[x]` em `tasks.md`
7. [ ] Atualizar `PROJECT_CONTEXT.md` se houve aprendizado relevante (2-5 linhas)
8. [ ] **STOP RULE**: parar e decidir conscientemente próximo slice
9. [ ] Se encerrar o dia: `git status` limpo ou WIP explícito e documentado
